from . import intcode, chain_intercodes, looping_intcodes
...
def test_day2_part1_examples():
    ...
    assert intcode([1, 1, 1, 4, 99, 5, 6, 0, 99])[1] == [30, 1, 1, 4, 2, 5, 6, 0, 99]
...
def test_day5_part2_examples():
    ...
    assert intcode([3, 12, 6, 12, 15, 1, 13, 14, 13, 4, 13, 99, -1, 0, 1, 9], [0])[0][-1] == 0
    assert intcode([3, 12, 6, 12, 15, 1, 13, 14, 13, 4, 13, 99, -1, 0, 1, 9], [7])[0][-1] == 1

    assert intcode([3, 3, 1105, -1, 9, 1101, 0, 0, 12, 4, 12, 99, 1], [0])[0][-1] == 0
    assert intcode([3, 3, 1105, -1, 9, 1101, 0, 0, 12, 4, 12, 99, 1], [7])[0][-1] == 1
